                    ...
                    case SPELL_DARK_MARTYRDOM_FANATIC:
                        _scheduler
                            .Schedule(Seconds(2), [this](TaskContext /*context*/)
                            {
                                ...
                                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_STUNNED | UNIT_FLAG_UNK_29 | UNIT_FLAG_UNINTERACTIBLE);
                            })
                            .Schedule(Seconds(6), [this](TaskContext /*context*/)
                            {
                                me->RemoveAurasDueToSpell(SPELL_PERMANENT_FEIGN_DEATH);
                                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_STUNNED | UNIT_FLAG_UNK_29 | UNIT_FLAG_UNINTERACTIBLE);
