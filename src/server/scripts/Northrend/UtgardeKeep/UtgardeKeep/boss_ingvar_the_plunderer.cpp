    ...
    public:
        ...
        struct boss_ingvar_the_plundererAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_UNINTERACTIBLE);
            ...
            void DamageTaken(Unit* /*doneBy*/, uint32& damage) override
            {
                if (damage >= me->GetHealth() && events.IsInPhase(PHASE_HUMAN))
                {
                    ...
                    me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_UNINTERACTIBLE);
