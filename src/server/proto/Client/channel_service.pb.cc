...
void ChannelService::RemoveMember(::bgs::protocol::channel::v1::RemoveMemberRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelService.RemoveMember(bgs.protocol.channel.v1.RemoveMemberRequest: {})",
...
void ChannelService::SendMessage(::bgs::protocol::channel::v1::SendMessageRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelService.SendMessage(bgs.protocol.channel.v1.SendMessageRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void ChannelService::UpdateChannelState(::bgs::protocol::channel::v1::UpdateChannelStateRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelService.UpdateChannelState(bgs.protocol.channel.v1.UpdateChannelStateRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void ChannelService::UpdateMemberState(::bgs::protocol::channel::v1::UpdateMemberStateRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelService.UpdateMemberState(bgs.protocol.channel.v1.UpdateMemberStateRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void ChannelService::Dissolve(::bgs::protocol::channel::v1::DissolveRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelService.Dissolve(bgs.protocol.channel.v1.DissolveRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
  ...
  switch(methodId) {
    case 2: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelService.RemoveMember server method call.", GetCallerInfo());
        SendResponse(service_hash_, 2, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.RemoveMember(bgs.protocol.channel.v1.RemoveMemberRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ...
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.RemoveMember() returned bgs.protocol.NoData: {} status %u.",
    ...
    case 3: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelService.SendMessage server method call.", GetCallerInfo());
        SendResponse(service_hash_, 3, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.SendMessage(bgs.protocol.channel.v1.SendMessageRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ChannelService* self = static_cast<ChannelService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.SendMessage() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 4: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelService.UpdateChannelState server method call.", GetCallerInfo());
        SendResponse(service_hash_, 4, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.UpdateChannelState(bgs.protocol.channel.v1.UpdateChannelStateRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ChannelService* self = static_cast<ChannelService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.UpdateChannelState() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 5: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelService.UpdateMemberState server method call.", GetCallerInfo());
        SendResponse(service_hash_, 5, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.UpdateMemberState(bgs.protocol.channel.v1.UpdateMemberStateRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ChannelService* self = static_cast<ChannelService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.UpdateMemberState() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 6: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelService.Dissolve server method call.", GetCallerInfo());
        SendResponse(service_hash_, 6, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.Dissolve(bgs.protocol.channel.v1.DissolveRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ChannelService* self = static_cast<ChannelService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelService.Dissolve() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
...
uint32 ChannelService::HandleRemoveMember(::bgs::protocol::channel::v1::RemoveMemberRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelService.RemoveMember(: {})",
    GetCallerInfo(), request->ShortDebugString());
...
uint32 ChannelService::HandleSendMessage(::bgs::protocol::channel::v1::SendMessageRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelService.SendMessage(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 ChannelService::HandleUpdateChannelState(::bgs::protocol::channel::v1::UpdateChannelStateRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelService.UpdateChannelState(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 ChannelService::HandleUpdateMemberState(::bgs::protocol::channel::v1::UpdateMemberStateRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelService.UpdateMemberState(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 ChannelService::HandleDissolve(::bgs::protocol::channel::v1::DissolveRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelService.Dissolve(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
void ChannelListener::OnJoin(::bgs::protocol::channel::v1::JoinNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnJoin(bgs.protocol.channel.v1.JoinNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::OnMemberAdded(::bgs::protocol::channel::v1::MemberAddedNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnMemberAdded(bgs.protocol.channel.v1.MemberAddedNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
  SendRequest(service_hash_, 2, request);
}

void ChannelListener::OnLeave(::bgs::protocol::channel::v1::LeaveNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnLeave(bgs.protocol.channel.v1.LeaveNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::OnMemberRemoved(::bgs::protocol::channel::v1::MemberRemovedNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnMemberRemoved(bgs.protocol.channel.v1.MemberRemovedNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::OnSendMessage(::bgs::protocol::channel::v1::SendMessageNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnSendMessage(bgs.protocol.channel.v1.SendMessageNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::OnUpdateChannelState(::bgs::protocol::channel::v1::UpdateChannelStateNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnUpdateChannelState(bgs.protocol.channel.v1.UpdateChannelStateNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::OnUpdateMemberState(::bgs::protocol::channel::v1::UpdateMemberStateNotification const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChannelListener.OnUpdateMemberState(bgs.protocol.channel.v1.UpdateMemberStateNotification: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChannelListener::CallServerMethod(uint32 token, uint32 methodId, MessageBuffer buffer) {
  switch(methodId) {
    case 1: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnJoin server method call.", GetCallerInfo());
        SendResponse(service_hash_, 1, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnJoin(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnJoin(bgs.protocol.channel.v1.JoinNotification: {}) status %u.",
    ...
    case 2: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnMemberAdded server method call.", GetCallerInfo());
        SendResponse(service_hash_, 2, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnMemberAdded(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnMemberAdded(bgs.protocol.channel.v1.MemberAddedNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 3: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnLeave server method call.", GetCallerInfo());
        SendResponse(service_hash_, 3, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnLeave(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnLeave(bgs.protocol.channel.v1.LeaveNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 4: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnMemberRemoved server method call.", GetCallerInfo());
        SendResponse(service_hash_, 4, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnMemberRemoved(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnMemberRemoved(bgs.protocol.channel.v1.MemberRemovedNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 5: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnSendMessage server method call.", GetCallerInfo());
        SendResponse(service_hash_, 5, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnSendMessage(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnSendMessage(bgs.protocol.channel.v1.SendMessageNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 6: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnUpdateChannelState server method call.", GetCallerInfo());
        SendResponse(service_hash_, 6, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnUpdateChannelState(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnUpdateChannelState(bgs.protocol.channel.v1.UpdateChannelStateNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 7: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChannelListener.OnUpdateMemberState server method call.", GetCallerInfo());
        SendResponse(service_hash_, 7, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnUpdateMemberState(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChannelListener.OnUpdateMemberState(bgs.protocol.channel.v1.UpdateMemberStateNotification: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
...
uint32 ChannelListener::HandleOnJoin(::bgs::protocol::channel::v1::JoinNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnJoin(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnMemberAdded(::bgs::protocol::channel::v1::MemberAddedNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnMemberAdded(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnLeave(::bgs::protocol::channel::v1::LeaveNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnLeave(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnMemberRemoved(::bgs::protocol::channel::v1::MemberRemovedNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnMemberRemoved(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnSendMessage(::bgs::protocol::channel::v1::SendMessageNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnSendMessage(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnUpdateChannelState(::bgs::protocol::channel::v1::UpdateChannelStateNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnUpdateChannelState(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChannelListener::HandleOnUpdateMemberState(::bgs::protocol::channel::v1::UpdateMemberStateNotification const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChannelListener.OnUpdateMemberState(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
