...
void ChallengeService::ChallengePicked(::bgs::protocol::challenge::v1::ChallengePickedRequest const* request, std::function<void(::bgs::protocol::challenge::v1::ChallengePickedResponse const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeService.ChallengePicked(bgs.protocol.challenge.v1.ChallengePickedRequest: {})",
...
void ChallengeService::ChallengeAnswered(::bgs::protocol::challenge::v1::ChallengeAnsweredRequest const* request, std::function<void(::bgs::protocol::challenge::v1::ChallengeAnsweredResponse const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeService.ChallengeAnswered(bgs.protocol.challenge.v1.ChallengeAnsweredRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
...
void ChallengeService::ChallengeCancelled(::bgs::protocol::challenge::v1::ChallengeCancelledRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeService.ChallengeCancelled(bgs.protocol.challenge.v1.ChallengeCancelledRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
...
void ChallengeService::SendChallengeToUser(::bgs::protocol::challenge::v1::SendChallengeToUserRequest const* request, std::function<void(::bgs::protocol::challenge::v1::SendChallengeToUserResponse const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeService.SendChallengeToUser(bgs.protocol.challenge.v1.SendChallengeToUserRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
  ...
  switch(methodId) {
    case 1: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeService.ChallengePicked server method call.", GetCallerInfo());
        SendResponse(service_hash_, 1, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengePicked(bgs.protocol.challenge.v1.ChallengePickedRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ...
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengePicked() returned bgs.protocol.challenge.v1.ChallengePickedResponse: {} status %u.",
    ...
    case 2: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeService.ChallengeAnswered server method call.", GetCallerInfo());
        SendResponse(service_hash_, 2, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengeAnswered(bgs.protocol.challenge.v1.ChallengeAnsweredRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::challenge::v1::ChallengeAnsweredResponse::descriptor());
        ChallengeService* self = static_cast<ChallengeService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengeAnswered() returned bgs.protocol.challenge.v1.ChallengeAnsweredResponse: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 3: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeService.ChallengeCancelled server method call.", GetCallerInfo());
        SendResponse(service_hash_, 3, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengeCancelled(bgs.protocol.challenge.v1.ChallengeCancelledRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ChallengeService* self = static_cast<ChallengeService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.ChallengeCancelled() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 4: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeService.SendChallengeToUser server method call.", GetCallerInfo());
        SendResponse(service_hash_, 4, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.SendChallengeToUser(bgs.protocol.challenge.v1.SendChallengeToUserRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::challenge::v1::SendChallengeToUserResponse::descriptor());
        ChallengeService* self = static_cast<ChallengeService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeService.SendChallengeToUser() returned bgs.protocol.challenge.v1.SendChallengeToUserResponse: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
...
uint32 ChallengeService::HandleChallengePicked(::bgs::protocol::challenge::v1::ChallengePickedRequest const* request, ::bgs::protocol::challenge::v1::ChallengePickedResponse* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeService.ChallengePicked(: {})",
    GetCallerInfo(), request->ShortDebugString());
...
uint32 ChallengeService::HandleChallengeAnswered(::bgs::protocol::challenge::v1::ChallengeAnsweredRequest const* request, ::bgs::protocol::challenge::v1::ChallengeAnsweredResponse* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeService.ChallengeAnswered(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 ChallengeService::HandleChallengeCancelled(::bgs::protocol::challenge::v1::ChallengeCancelledRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeService.ChallengeCancelled(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 ChallengeService::HandleSendChallengeToUser(::bgs::protocol::challenge::v1::SendChallengeToUserRequest const* request, ::bgs::protocol::challenge::v1::SendChallengeToUserResponse* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeService.SendChallengeToUser(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
void ChallengeListener::OnChallengeUser(::bgs::protocol::challenge::v1::ChallengeUserRequest const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeListener.OnChallengeUser(bgs.protocol.challenge.v1.ChallengeUserRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChallengeListener::OnChallengeResult(::bgs::protocol::challenge::v1::ChallengeResultRequest const* request) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method ChallengeListener.OnChallengeResult(bgs.protocol.challenge.v1.ChallengeResultRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
...
void ChallengeListener::CallServerMethod(uint32 token, uint32 methodId, MessageBuffer buffer) {
  switch(methodId) {
    case 1: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeListener.OnChallengeUser server method call.", GetCallerInfo());
        SendResponse(service_hash_, 1, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnChallengeUser(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeListener.OnChallengeUser(bgs.protocol.challenge.v1.ChallengeUserRequest: {}) status %u.",
    ...
    case 2: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeListener.OnChallengeResult server method call.", GetCallerInfo());
        SendResponse(service_hash_, 2, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnChallengeResult(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeListener.OnChallengeResult(bgs.protocol.challenge.v1.ChallengeResultRequest: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 3: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeListener.OnExternalChallenge server method call.", GetCallerInfo());
        SendResponse(service_hash_, 3, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnExternalChallenge(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeListener.OnExternalChallenge(bgs.protocol.challenge.v1.ChallengeExternalRequest: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
    ...
    case 4: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ChallengeListener.OnExternalChallengeResult server method call.", GetCallerInfo());
        SendResponse(service_hash_, 4, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      uint32 status = HandleOnExternalChallengeResult(&request);
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ChallengeListener.OnExternalChallengeResult(bgs.protocol.challenge.v1.ChallengeExternalResult: {}) status %u.",
        GetCallerInfo(), request.ShortDebugString(), status);
      if (status)
...
uint32 ChallengeListener::HandleOnChallengeUser(::bgs::protocol::challenge::v1::ChallengeUserRequest const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeListener.OnChallengeUser(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChallengeListener::HandleOnChallengeResult(::bgs::protocol::challenge::v1::ChallengeResultRequest const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeListener.OnChallengeResult(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChallengeListener::HandleOnExternalChallenge(::bgs::protocol::challenge::v1::ChallengeExternalRequest const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeListener.OnExternalChallenge(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}

uint32 ChallengeListener::HandleOnExternalChallengeResult(::bgs::protocol::challenge::v1::ChallengeExternalResult const* request) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ChallengeListener.OnExternalChallengeResult(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
