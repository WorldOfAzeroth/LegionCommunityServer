...
void PresenceService::Subscribe(::bgs::protocol::presence::v1::SubscribeRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.Subscribe(bgs.protocol.presence.v1.SubscribeRequest: {})",
...
void PresenceService::Unsubscribe(::bgs::protocol::presence::v1::UnsubscribeRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.Unsubscribe(bgs.protocol.presence.v1.UnsubscribeRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void PresenceService::Update(::bgs::protocol::presence::v1::UpdateRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.Update(bgs.protocol.presence.v1.UpdateRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void PresenceService::Query(::bgs::protocol::presence::v1::QueryRequest const* request, std::function<void(::bgs::protocol::presence::v1::QueryResponse const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.Query(bgs.protocol.presence.v1.QueryRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
...
void PresenceService::Ownership(::bgs::protocol::presence::v1::OwnershipRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.Ownership(bgs.protocol.presence.v1.OwnershipRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void PresenceService::SubscribeNotification(::bgs::protocol::presence::v1::SubscribeNotificationRequest const* request, std::function<void(::bgs::protocol::NoData const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.SubscribeNotification(bgs.protocol.presence.v1.SubscribeNotificationRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
    ::bgs::protocol::NoData response;
    if (response.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize()))
...
void PresenceService::MigrateOlympusCustomMessage(::bgs::protocol::presence::v1::MigrateOlympusCustomMessageRequest const* request, std::function<void(::bgs::protocol::presence::v1::MigrateOlympusCustomMessageResponse const*)> responseCallback) {
  TC_LOG_DEBUG("service.protobuf", "{} Server called client method PresenceService.MigrateOlympusCustomMessage(bgs.protocol.presence.v1.MigrateOlympusCustomMessageRequest: {})",
    GetCallerInfo(), request->ShortDebugString());
  std::function<void(MessageBuffer)> callback = [responseCallback](MessageBuffer buffer) -> void {
  ...
  switch(methodId) {
    case 1: {
      ...
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ...
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Subscribe() returned bgs.protocol.NoData: {} status %u.",
    ...
    case 2: {
      ...
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Unsubscribe() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 3: {
      ...
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Update() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 4: {
      ...
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ...
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Query() returned bgs.protocol.presence.v1.QueryResponse: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 5: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for PresenceService.Ownership server method call.", GetCallerInfo());
        SendResponse(service_hash_, 5, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Ownership(bgs.protocol.presence.v1.OwnershipRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.Ownership() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 7: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for PresenceService.SubscribeNotification server method call.", GetCallerInfo());
        SendResponse(service_hash_, 7, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.SubscribeNotification(bgs.protocol.presence.v1.SubscribeNotificationRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.SubscribeNotification() returned bgs.protocol.NoData: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
    ...
    case 8: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for PresenceService.MigrateOlympusCustomMessage server method call.", GetCallerInfo());
        SendResponse(service_hash_, 8, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.MigrateOlympusCustomMessage(bgs.protocol.presence.v1.MigrateOlympusCustomMessageRequest: {}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::presence::v1::MigrateOlympusCustomMessageResponse::descriptor());
        PresenceService* self = static_cast<PresenceService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method PresenceService.MigrateOlympusCustomMessage() returned bgs.protocol.presence.v1.MigrateOlympusCustomMessageResponse: {} status %u.",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
...
uint32 PresenceService::HandleOwnership(::bgs::protocol::presence::v1::OwnershipRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method PresenceService.Ownership(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 PresenceService::HandleSubscribeNotification(::bgs::protocol::presence::v1::SubscribeNotificationRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method PresenceService.SubscribeNotification(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
...
uint32 PresenceService::HandleMigrateOlympusCustomMessage(::bgs::protocol::presence::v1::MigrateOlympusCustomMessageRequest const* request, ::bgs::protocol::presence::v1::MigrateOlympusCustomMessageResponse* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method PresenceService.MigrateOlympusCustomMessage(: {})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
