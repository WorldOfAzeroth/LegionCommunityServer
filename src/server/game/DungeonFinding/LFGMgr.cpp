...
LFGDungeonData::LFGDungeonData() : id(0), name(), map(0), type(0), expansion(0), group(0),
...
LFGDungeonData::LFGDungeonData(LFGDungeonsEntry const* dbc) : id(dbc->ID), name(dbc->Name[sWorld->GetDefaultDbcLocale()]), map(dbc->MapID),
    type(uint8(dbc->TypeID)), expansion(uint8(dbc->ExpansionLevel)), group(uint8(dbc->GroupID)), difficulty(Difficulty(dbc->DifficultyID)),
