...
class TC_GAME_API WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        int32 CalculateSpellDamage(Unit const* target, SpellEffectInfo const& spellEffectInfo, int32 const* basePoints = nullptr, float* variance = nullptr, int32 itemLevel = -1) const;
