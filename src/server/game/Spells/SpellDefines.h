...
class ProcFlagsInit : public FlagsArray<int32, 1>
{
    using Base = FlagsArray<int32, 1>;

public:
    constexpr ProcFlagsInit(ProcFlags procFlags = {})
    {
    ...
    constexpr ProcFlagsInit& operator=(int32 const& right)
    {
        _storage[0] = right;
        return *this;
    }
