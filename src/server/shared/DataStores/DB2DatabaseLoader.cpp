...
char* DB2DatabaseLoader::Load(uint32& records, char**& indexTable, std::vector<char*>& stringPool)
{
...
void DB2DatabaseLoader::LoadStrings(LocaleConstant locale, uint32 records, char** indexTable, std::vector<char*>& stringPool)
{
