...
public:
    ...
    char* Load(uint32& records, char**& indexTable, std::vector<char*>& stringPool);
    void LoadStrings(LocaleConstant locale, uint32 records, char** indexTable, std::vector<char*>& stringPool);
