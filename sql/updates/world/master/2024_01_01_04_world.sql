...
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-8, `LevelScalingDeltaMax`=-7, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13317 AND `DifficultyID`=0); -- Coldmine Miner
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-6, `LevelScalingDeltaMax`=-5, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13087 AND `DifficultyID`=0); -- Coldmine Invader
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-2, `LevelScalingDeltaMax`=-2, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13086 AND `DifficultyID`=0); -- Aggi Rumblestomp
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-8, `LevelScalingDeltaMax`=-7, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13316 AND `DifficultyID`=0); -- Coldmine Peon
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-2, `LevelScalingDeltaMax`=-2, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13088 AND `DifficultyID`=0); -- Masha Swiftcut
UPDATE `creature_template_difficulty` SET `SandboxScalingId`=982, `VerifiedBuild`=52649 WHERE (`Entry`=14751 AND `DifficultyID`=0); -- Frostwolf Battle Standard
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-6, `LevelScalingDeltaMax`=-5, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13089 AND `DifficultyID`=0); -- Coldmine Guard
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-6, `LevelScalingDeltaMax`=-5, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13097 AND `DifficultyID`=0); -- Coldmine Surveyor
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-2, `LevelScalingDeltaMax`=-2, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13078 AND `DifficultyID`=0); -- Umi Thorson
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-6, `LevelScalingDeltaMax`=-5, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13080 AND `DifficultyID`=0); -- Irondeep Guard
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-8, `LevelScalingDeltaMax`=-7, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13396 AND `DifficultyID`=0); -- Irondeep Miner
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-6, `LevelScalingDeltaMax`=-5, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13098 AND `DifficultyID`=0); -- Irondeep Surveyor
...
UPDATE `creature_template_difficulty` SET `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=11997 AND `DifficultyID`=0); -- Stormpike Herald
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-2, `LevelScalingDeltaMax`=-2, `SandboxScalingId`=663, `VerifiedBuild`=52649 WHERE (`Entry`=13447 AND `DifficultyID`=0); -- Corporal Noreg Stormpike
...
UPDATE `creature_template_difficulty` SET `SandboxScalingId`=982, `VerifiedBuild`=51972 WHERE (`Entry`=14465 AND `DifficultyID`=0); -- Alliance Battle Standard
...
UPDATE `creature_template_difficulty` SET `LevelScalingDeltaMin`=-2, `LevelScalingDeltaMax`=-2, `SandboxScalingId`=663, `VerifiedBuild`=51972 WHERE (`Entry`=11677 AND `DifficultyID`=0); -- Taskmaster Snivvle
UPDATE `creature_template_difficulty` SET `SandboxScalingId`=663, `VerifiedBuild`=51972 WHERE (`Entry`=11997 AND `DifficultyID`=0); -- Stormpike Herald
