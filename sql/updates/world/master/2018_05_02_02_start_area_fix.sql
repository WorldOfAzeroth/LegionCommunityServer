...
INSERT INTO `gameobject` (`guid`,`id`,`map`,`zoneId`,`areaId`,`phaseUseFlags`,`PhaseId`,`PhaseGroup`,`terrainSwapMap`,`position_x`,`position_y`,`position_z`,`orientation`,`rotation0`,`rotation1`,`rotation2`,`rotation3`,`spawntimesecs`,`animprogress`,`state`,`ScriptName`,`VerifiedBuild`) VALUES
(19578, 181286, 530, 6456, 3527, 0, 0, 0, -1, -4095.24, -13747.7, 74.6892, 3.85195, 0, 0, 0.937584, -0.347758, 600, 100, 1, '', 0),
(19579, 181286, 530, 6456, 3527, 0, 0, 0, -1, -4187.71, -13738.7, 74.42, 5.56, 0, 0, 0.353764, -0.935335, 600, 100, 1, '', 0);
UPDATE `creature` SET `wander_distance` = 0, `MovementType` = 0 WHERE `id` IN (38345,43599);